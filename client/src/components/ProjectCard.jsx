import ProjectCardCSS from "../assets/css/ProjectCard.module.scss";
import PropTypes from "prop-types";

function ProjectCard({ src, title, text, gitLink, demoLink }) {
  return (
    <div className={ProjectCardCSS["projectCard"]}>
      <img
        className={ProjectCardCSS["projectCard__img"]}
        src={src}
        alt={title}
      />
      <span className={ProjectCardCSS["projectCard__title"]}>{title}</span>
      <p className={ProjectCardCSS["projectCard__text"]}>{text}</p>
      <div className={ProjectCardCSS["projectCard__buttons"]}>
        <a href={demoLink} className={ProjectCardCSS["projectCard__demoBtn"]}>
          Demo
          <svg
        ...
        <a href={gitLink} className={ProjectCardCSS["projectCard__githubBtn"]}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="2.2rem"
            height="2.2rem"
